...
#include "MDB-c_1008471798.c"           // <--- This will import your code so we can
...
int main()
{
    ...
    queryReviewsByScore(60, MDB_head);
    ...
    insertCastMember("aba", "Universal Studios", 1985, MDB_head, "Michael J. Fox",250.12);
    insertCastMember("aba", "Universal Studios", 1985, MDB_head, "a", 250.12);
    printf("\n%s\n", MDB_head->review.cast->next->name);
